...
RAW_DIR="$ROOT_DIR/dataset/raw_msasl_expanded"
PROCESSED_DIR="$ROOT_DIR/dataset/processed_msasl_expanded"
ARTIFACTS_DIR="$ROOT_DIR/artifacts/asl_dynamic_expanded"
