...
const GESTURE_TRANSLATIONS: Record<string, TranslationMap> = {
  'hello': {
    ...
    ar: 'مرحبا',      ru: 'Привет',          zh: '你好',            pt: 'Olá',
  ...
  'please': {
    ...
    ar: 'من فضلك',    ru: 'Пожалуйста',      zh: '请',              pt: 'Por favor',
  ...
  'help': {
    ...
    ar: 'مساعدة',     ru: 'Помощь',          zh: '帮助',             pt: 'Ajuda',
  ...
  'goodbye': {
    ...
    ar: 'وداعا',           ru: 'До свидания',     zh: '再见',              pt: 'Adeus',
  ...
  'blank': {
    ...
    ar: 'فارغ',        ru: 'Пусто',           zh: '空白',             pt: 'Vazio',
  ...
  'eat / speak': {
    ...
    ar: 'أكل / تكلم',       ru: 'Есть / Говорить',    zh: '吃/说话',             pt: 'Comer / Falar',
  ...
  'see / look': {
    ...
    ar: 'رؤية / نظر', ru: 'Видеть',          zh: '看',               pt: 'Ver',
  ...
  'smell': {
    ...
    ar: 'شم',         ru: 'Нюхать',           zh: '闻',               pt: 'Cheirar',
  ...
  'think': {
    ...
    ar: 'تفكير',      ru: 'Думать',           zh: '思考',             pt: 'Pensar',
  ...
  'listen': {
    ...
    ar: 'استمع',      ru: 'Слушать',          zh: '听',               pt: 'Ouvir',
...
export const LANGUAGE_BCP47: Record<string, string> = {
  ...
  ar: 'ar-SA', ru: 'ru-RU', zh: 'zh-CN', pt: 'pt-PT',
